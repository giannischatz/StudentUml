...
Actions.prototype.init = function()
{
	...
	console.log("Actions.js start of the graph")
	...
	this.addAction('open...', function()
	{
        ...
        this.addAction('validation', function() {
	...
	this.addAction('import...', function()
	{
		...
		//Creation of a button for getting the state of the diagram
//            var encoder = new mxCodec();
//            var result = encoder.encode(graph.getModel());
//            var xml = mxUtils.getXml(result);
//            console.log("xml: ", xml);
	...
	this.addAction('dcd', function() { ui.newDiagram(); }, null, null, null).isEnabled = isGraphEnabled;
	this.addAction('ssd', function() { ui.newDiagram(); }, null, null, null).isEnabled = isGraphEnabled;
	this.addAction('saveAs...', function() { ; 
            ...
            ui.saveFile(true, xml);
//            
//           var blob = new Blob([xml], {type: "text/plain;charset=utf-8"});
//            saveAs(blob, "testfile.xml");
