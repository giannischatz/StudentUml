 ...
 * Sets the default font size.
 */
//Menus.prototype.defaultMenuItems = ['diagram', 'file', 'edit', 'view', 'arrange', 'extras', 'help'];
Menus.prototype.defaultMenuItems = ['diagram'];
...
//	})));
	...
	//{
	//this.addMenuItems(menu, ["CD","SSD"], parent);
	//})));
